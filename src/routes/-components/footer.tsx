    ...
    return (
        <footer className="relative z-10">
            ...
            <div className="mx-auto max-w-5xl px-4 pb-10 z-10">
                <div className="mt-10">
                    <p className="font-heading text-2xl">Harsh Gaur</p>
                    <p className="mt-1 text-sm italic text-mist-500">Turning ideas into production-ready platforms.</p>
                    <p className="mt-4 text-xs text-mist-400">© {new Date().getFullYear()} Harsh Gaur</p>
                </div>
                ...
                <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 text-sm text-mist-700">
                    ...
                    <a href="mailto:hgaur491@gmail.com">Email ↗</a>
                    <a href="/harsh-gaur-frontend-engineer.pdf" download>
                        Resume ⤓
                    </a>
                    <span>|</span>
                    <a href="/sitemap.xml" className="ml-auto">
                        Sitemap
                    </a>
                </div>
