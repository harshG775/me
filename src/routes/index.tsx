        ...
        <main id="top" className="pt-12">
                    ...
                    <dl>
                        ...
                        <dd>
                            <ul>
                                ...
                                <li>
                                    TanStack Form and Zod drive a schema-based form system, so validation follows the
                                    resume structure.
                                </li>
            ...
            <section id="about" aria-labelledby="about-heading" className="max-w-4xl mx-auto">
                ...
                <p>
                    ...
                    WebAssembly, and I publish open-source proofs of concept to test architecture ideas. I'm looking for
                    a front-end role where I can work on complex, product-scale problems.
                </p>
                <h3>Education</h3>
                <ul>
                    <li>
