        ...
        <div className="min-h-screen bg-muted p-4 md:p-8">
            <div className="max-w-7xl mx-auto">
                <div className="grid-container">
                    {/* Header/Intro */}
                    <div className="intro bg-background rounded-2xl shadow-md p-6 flex flex-col justify-center">
                    ...
                    {/* About */}
                    <div className="about bg-background rounded-2xl shadow-md p-6 flex flex-col justify-center">
                        <div className="flex items-center mb-4">
                            <User className="w-5 h-5 mr-2 text-secondary-foreground" />
                            <h3 className="text-xl font-semibold">About Me</h3>
                        </div>
                        <p className="text-gray-600">
                            Passionate developer with 5+ years of experience creating web applications that combine
                            functionality with stunning design.
                        </p>
                    </div>

                    {/* Skills */}
                    <div className="skills bg-background rounded-2xl shadow-md p-6">
                        <div className="flex items-center mb-4">
                    ...
                    <div className="projects rounded-2xl shadow-md overflow-hidden">
                    ...
                    {/* Contact */}
                    <div className="contact bg-background rounded-2xl shadow-md p-6">
                        <div className="flex items-center mb-4">
                    ...
                    {/* Social Links */}
                    <div className="social bg-background rounded-2xl shadow-md p-6">
                        <div className="flex items-center mb-4">
